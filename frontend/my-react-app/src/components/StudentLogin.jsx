...
const StudentLogin = () => {
  ...
  const handleLoginClick = () => {
    ...
    navigate("/ViewResult"); // Redire"/ViewResult"cts to the /dashboard route
  };
    ...
    <div style={styles.container} className="animated-title">
      <div style={styles.overlay}>
        <div style={styles.formContainer}>
          <h2 style={styles.title} className="animated-title">Student Login</h2>
...
const styles = {
  container: {
    ...
    backgroundImage: 'url("https://static.vecteezy.com/system/resources/previews/001/311/554/original/education-and-back-to-school-concept-free-vector.jpg")', // Replace with a background image URL
